        ...
        <div class="container">
            <div class="row card" style="padding-top: 1px; padding-bottom: 20px;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <pre><code class="pre-code-custom">docker run -dit --restart=always -e FLARE_BIND_ADDRESS=0.0.0.0 -p 9650:9650 --name my_flare_server asclinux/flarelinux:1.1.5-1.9.0-0.7.0 flare --flare-coston2</code></pre>
                    </div>
                    <div class="col-sm-2">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-sm-8">
                        ...
                        <p>
                            ...
                            <span class="small">You can find the Flare Network code repository at: <a class="dark-link" href="https://github.com/flare-foundation/flare" target="_blank">https://github.com/flare-foundation/flare</a></span>
                        </p>
                        <hr>
                    </div>
                    <div class="col-sm-2"></div>
