        ...
        <div class="container">
            <div class="row card" style="padding-top: 1px; padding-bottom: 20px;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8">
                        <pre><code class="pre-code-custom">docker run -dit --restart=always -e FLARE_BIND_ADDRESS=0.0.0.0 -p 9650:9650 --name my_flare_server asclinux/flarelinux:1.1.6-1.11.0a flare --flare-coston2</code></pre>
                    </div>
                    <div class="col-sm-2">
